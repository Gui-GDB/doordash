package com.gdb.doordash.aspect;

import com.gdb.doordash.annotation.AutoFill;
import com.gdb.doordash.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.gdb.doordash.mapper..*(..)) && @annotation(com.gdb.doordash.annotation.AutoFill)")
